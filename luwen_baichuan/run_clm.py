...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        model = AutoModelForCausalLM.from_pretrained(
            ...
            low_cpu_mem_usage=model_args.low_cpu_mem_usage, trust_remote_code=True
        )
    else:
    ...
    if not model_args.pretrain:
        def tokenize_function(examples):
            output = tokenizer(examples[text_column_name], max_length=max_seq_length, truncation=True)
